...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Elmersa - المرصة" },
      { name: "twitter:title", content: "Elmersa - المرصة" },
      { property: "og:description", content: "Elmersa / المرصة - annonces Mauritanie" },
      { name: "twitter:description", content: "Elmersa / المرصة - annonces Mauritanie" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/91bc0ad7-1e2c-4f59-a7a0-9bffcb82044f/id-preview-d3af9dcf--16969799-b508-4f36-b8c3-0402719deb09.lovable.app-1779131552390.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/91bc0ad7-1e2c-4f59-a7a0-9bffcb82044f/id-preview-d3af9dcf--16969799-b508-4f36-b8c3-0402719deb09.lovable.app-1779131552390.png" },
